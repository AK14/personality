        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="image">
                        <img src="{{URL::asset('/img/minina/minina.jpg')}}" class="img-fluid" alt="">
                    </div>
                </div>
...
<!--                        <p>
    ...
    <section id="services" class="services">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-up">
                <h2>Формы работы</h2>
                <p>Благодаря совместной психологической работе вы сможете пережить трудный жизненный период, лучше понять свои собственные мотивы и ценности, развить эмоциональную чувствительность к себе и другому, повысить самооценку, улучшить качество собственной жизни, выстроить внутренние психологические опоры.</p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 order-2 order-lg-1">
                    ...
                    <div class="icon-box mt-5" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <h4>Краткосрочная работа по определённому запросу (10 встреч)</h4>
                        <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt</p>
                    </div>
                    <div class="icon-box mt-5" data-aos="fade-up" data-aos-delay="200">
                        <i class="bx bx-images"></i>
                        <h4>Долгосрочная работа (более 10 встреч)</h4>
                        <p>Aut suscipit aut cum nemo deleniti aut omnis. Doloribus ut maiores omnis facere</p>
                    </div>
                    <div class="icon-box mt-5" data-aos="fade-up" data-aos-delay="300">
                        <i class="bx bx-shield"></i>
                        <h4>Групповая терапия</h4>
                        <p>Expedita veritatis consequuntur nihil tempore laudantium vitae denat pacta</p>
                    </div>

                    <div class="icon-box mt-5" data-aos="fade-up" data-aos-delay="300">
                        <i class="bx bx-shield"></i>
                        <h4>Индивидуальная супервизия</h4>
                        <p>Expedita veritatis consequuntur nihil tempore laudantium vitae denat pacta</p>
                    </div>
                    <div class="icon-box mt-5" data-aos="fade-up" data-aos-delay="300">
                        <i class="bx bx-shield"></i>
                        <h4>Групповая супервизия</h4>
                        <p>Expedita veritatis consequuntur nihil tempore laudantium vitae denat pacta</p>
                    </div>
                </div>
                <div class="image col-lg-6 order-1 order-lg-2" style='background-image: url("{{URL::asset('/img/services.jpg')}}");' data-aos="fade-left" data-aos-delay="100"></div>
            </div>
                ...
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="tab-content">
                        <div class="tab-pane active show" id="tab-1">
                            <figure>
                                <img src="{{URL::asset('/img/featured-1.png')}}" alt="" class="img-fluid">
                            </figure>
                        </div>
                        <div class="tab-pane" id="tab-2">
                            <figure>
                                <img src="{{URL::asset('/img/featured-2.png')}}" alt="" class="img-fluid">
                            </figure>
                        </div>
                        <div class="tab-pane" id="tab-3">
                            <figure>
                                <img src="{{URL::asset('/img/featured-3.png')}}" alt="" class="img-fluid">
                            </figure>
                        </div>
                        <div class="tab-pane" id="tab-4">
                            <figure>
                                <img src="{{URL::asset('/img/featured-4.png')}}" alt="" class="img-fluid">
                            </figure>
                        </div>
                    </div>
                </div>
    ...
    <section id="why-us" class="why-us">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 order-1 order-lg-2 align-items-stretch video-box" style='background-image: url("{{URL::asset('/img/why-us.jpg')}}");' data-aos="zoom-in">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-4 col-6" data-aos="zoom-in">
                    <img src="{{URL::asset('/img/clients/client-1.png')}}" class="img-fluid" alt="">
                </div>

                <div class="col-lg-2 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="100">
                    <img src="{{URL::asset('/img/clients/client-2.png')}}" class="img-fluid" alt="">
                </div>

                <div class="col-lg-2 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="200">
                    <img src="{{URL::asset('/img/clients/client-3.png')}}" class="img-fluid" alt="">
                </div>

                <div class="col-lg-2 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="300">
                    <img src="{{URL::asset('/img/clients/client-4.png')}}" class="img-fluid" alt="">
                </div>

                <div class="col-lg-2 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="400">
                    <img src="{{URL::asset('/img/clients/client-5.png')}}" class="img-fluid" alt="">
                </div>

                <div class="col-lg-2 col-md-4 col-6" data-aos="zoom-in" data-aos-delay="500">
                    <img src="{{URL::asset('/img/clients/client-6.png')}}" class="img-fluid" alt="">
                </div>
